        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 lg:grid-cols-5 lg:items-end">
            ...
            <div className="lg:col-span-2 grid grid-cols-3 gap-3">
              {[
                { value: "Statewide", label: "Coverage", bg: "#FFFFFF", accent: teal },
                { value: "Licensed", label: "Data Focus", bg: lightPink, accent: pink },
                { value: "Free", label: "For Parents", bg: lightGold, accent: gold },
              ].map((stat) => (
      ...
      <main className="px-6 py-8">
        ...
        <section>
          ...
          <ul className="mt-3 space-y-2 text-sm leading-relaxed" style={{ color: `${dark}bb` }}>
            <li>• Organizes licensed provider listings in a searchable, parent-friendly format</li>
