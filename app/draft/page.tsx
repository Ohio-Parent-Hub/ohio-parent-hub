...
const options = [
  {
    ...
    desc: "Dark navy/charcoal with electric blue and warm amber. Sleek, professional, modern.",
  ...
  },
  {
    ...
    name: "Sunrise Warm",
    category: "Custom Theme",
    desc: "Terracotta, burnt orange, warm cream, deep brown. Earthy, cozy, organic.",
    colors: ["#C2704D", "#D4824A", "#5C3D2E", "#7A8B5D"],
  },
  {
    id: 3,
    name: "Ocean Breeze",
    category: "Custom Theme",
    desc: "Coastal blues, sandy beige, coral, seafoam. Fresh, clean, airy.",
    colors: ["#2980B9", "#76D7C4", "#E87461", "#F5E6D3"],
  },
  {
    id: 4,
    name: "Garden Party",
    category: "Custom Theme",
    desc: "Rich greens, floral pinks, cream, golden yellow. Lush, botanical, vibrant.",
    colors: ["#2D5016", "#E84393", "#F1C40F", "#4A7C28"],
  },
  {
    id: 5,
    name: "Candy Pop",
    category: "Custom Theme",
    desc: "Bold primary colors: hot pink, electric blue, sunny yellow, lime. Energetic, playful.",
    colors: ["#FF1493", "#00BFFF", "#FFD700", "#7CFC00"],
  },
  {
    id: 6,
